...
import gov.nist.hit.erx.service.exception.MessageContentNotFoundException;
...
public class Utils {
    ...
    public static String getContent(Command request) {
        if (request == null || "".equals(request.getContent())) {
            throw new MessageContentNotFoundException("No message content found in the request");
        }
